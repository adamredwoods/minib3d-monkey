...
Class TSurface
	...
	Field vert_anim:TVertexAnim[] ''surf.vert_anim array should be null until it is set
	...
	Method VertexZ#(vid)
		...
		Return -vert_data.VertexZ(vid)' ***ogl***
	...
	Method VertexNZ#(vid)
		...
		Return -vert_data.VertexNZ(vid)' ***ogl***
