...
'' same as in opengl & xna??
'' whould a 'trender.LoadImageData' not do it?

Class D3D11Pixmap Extends TPixmap Implements IPixmapManager
	...
	Function Init()
		...
		If Not manager Then manager = New D3D11Pixmap
	...
	Method LoadPixmap:TPixmap(f$)
		...
		Local p:D3D11Pixmap = New D3D11Pixmap
	...
	Method CreatePixmap:D3D11Pixmap(w:Int, h:Int, format:Int=PF_RGBA8888)
	...
	Method ResizePixmap:TPixmap(neww:Int, newh:Int)
		...
		Local newpix:= CreatePixmap(neww, newh)
